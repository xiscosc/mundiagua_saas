...
from .views import SearchClientView, CreateBudgetView, CreateLineBudgetView, TypeAheadBudgetView, BudgetDetailView, \
    EditLineBudgetView, ListBudgetView, PreSearchBudgetView, SearchBudgetView, ListBudgetRepairView, CreateBudgetRepairView, CreateLineBudgetRepairView, BudgetRepairDetailView, EditLineBudgetRepairView
