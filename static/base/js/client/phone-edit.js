...
$(function() {
    $text = $('#id_international_code');
    var value = parseInt($text.val());
    $parent = $text.parent();
    var html_text = "<select class='form-control' name='international_code' id='id_international_code'></select>";
    $parent.html(html_text);
    $select = $('#id_international_code');
    $.each(data_phones, function (i, val) {
        var nombre = val.nombre + " (+" + val.phone_code + ")";
        if (value != parseInt(val.phone_code)) {
            code = "<option value='"+val.phone_code+"'>"+nombre+"</option>";
        } else {
            code = "<option selected value='"+val.phone_code+"'>"+nombre+"</option>";
        }
        $select.append(code);
    })
