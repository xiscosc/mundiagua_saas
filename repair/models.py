...
class AthRepair(models.Model):
    ...
    online_id = models.CharField(max_length=25, blank=True)
    model = models.BooleanField(default=False)
    year = models.CharField(max_length=25, blank=True)
    serial_number = models.CharField(max_length=100, blank=True)
    notice_maker_number = models.CharField(max_length=50, blank=True)
    budget = models.ForeignKey('budget.Budget', null=True)
    description = models.TextField()
    intern_description = models.TextField(blank=True)
